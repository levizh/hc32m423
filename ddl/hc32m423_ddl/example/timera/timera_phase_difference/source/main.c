 ...
 * @retval None
 */
void TIMERA_1_Udf_IrqHandler(void)
{
    LED_G_TOGGLE();
...
static void Timera_Config(void)
{
    ...
    NVIC_ClearPendingIRQ(TmrA1UDF_IRQn);
    NVIC_SetPriority(TmrA1UDF_IRQn, DDL_IRQ_PRIORITY_DEFAULT);
    NVIC_EnableIRQ(TmrA1UDF_IRQn);
